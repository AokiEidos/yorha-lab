...
> 🔬 深入 | 前置知识：[得分函数与得分匹配](../01-fundamentals/06-score-matching.md)，[SDE/ODE 统一视角](../01-fundamentals/07-sde-ode.md)
...
> **下一篇**：[Latent Diffusion 与 Stable Diffusion](./04-latent-diffusion.md)
