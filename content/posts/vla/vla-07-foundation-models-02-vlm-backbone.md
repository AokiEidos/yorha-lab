...
> ⚙️ 进阶 | 前置知识：[VLM 回顾](../01-foundations/01-vlm-review.md)，[多模态输入融合](../02-architecture/04-multimodal-fusion.md)
...
> **下一篇**：[Diffusion 作为动作生成器](./03-diffusion-action.md) — Diffusion Policy 和 Flow Matching 在 VLA 中的应用。
