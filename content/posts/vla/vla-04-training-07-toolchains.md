...
> **难度**: 🔰入门 → ⚙️进阶 | **前置阅读**: [4.1 大规模机器人数据集](./01-datasets.md), [4.3 预训练与微调范式](./03-pretrain-finetune.md)
...
> **模块总结**: 本模块（Module 4: Training）覆盖了VLA训练的完整流程。继续阅读 [Module 5](../05-deployment/) 了解如何将训练好的VLA部署到真实机器人上。
