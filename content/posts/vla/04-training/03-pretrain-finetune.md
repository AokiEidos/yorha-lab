...
> **难度**: ⚙️进阶 | **前置阅读**: [2.1 整体架构](../02-architecture/01-vlm-to-vla), [4.1 大规模机器人数据集](./01-datasets)
...
如[3.x 扩散策略](../models-zoo-) 所述，使用**扩散过程（Diffusion Process）** 生成动作序列：
...
> **下一节**: [4.4 跨具身体迁移](./04-cross-embodiment) - 不同机器人的数据如何互相帮助？
