...
> **难度**: ⚙️进阶 | **前置阅读**: [4.3 预训练与微调范式](./03-pretrain-finetune), [2.1 整体架构](../02-architecture/01-vlm-to-vla)
...
Adapter除了用于高效微调，还被用于[4.4 跨具身体迁移](./04-cross-embodiment)中的具身体特定适配：
...
> **下一节**: [4.7 开源工具链](./07-toolchains) - 有哪些现成的训练工具可以使用？
