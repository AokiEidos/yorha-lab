...
> ⚙️ 进阶 → 🔬 深入 | 前置知识：[动作解码头设计](../02-architecture/03-action-head.md)
> 交叉引用：[Diffusion 系列 · 基础理论](../../diffusion/01-fundamentals/01-core-intuition.md)，[Diffusion 系列 · Flow Matching](../../diffusion/02-models-zoo/06-flow-matching.md)
...
> **下一篇**：[具身智能 Agent 框架](./04-embodied-agent.md) — VLA 在完整 Agent 系统中的定位。
