...
> **难度**: 🔰入门 | **前置阅读**: [1.1 什么是VLA](../01-foundations/01-what-is-vla.md), [2.1 整体架构](../02-architecture/01-overview.md)
...
| **机器人多样性** | 不同具身体的数据 | 实现跨具身体迁移（见 [4.4](./04-cross-embodiment.md)） |
...
详细的数据加载与使用方法参见 [4.7 开源工具链](./07-toolchains.md)。
...
> **下一节**: [4.2 数据收集与标注](./02-data-collection.md) - 这些数据是如何获取的？
