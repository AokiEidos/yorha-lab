...
> 🔰 入门 → ⚙️ 进阶 | 前置知识：[扩散模型核心直觉](./01-core-intuition.md)，基本概率论（高斯分布、条件概率）
...
SNR 提供了一个与具体调度策略无关的统一视角来理解噪声水平（详见 [噪声调度](./05-noise-schedule.md)）。
...
> **下一篇**：[反向过程与训练目标](./03-reverse-process.md) — 如何训练神经网络逆转加噪过程，以及三种主要的参数化方式。
