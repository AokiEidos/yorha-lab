...
> ⚙️ 进阶 | 前置知识：[DDPM 详解](./01-ddpm.md)，[SDE/ODE 统一视角](../01-fundamentals/07-sde-ode.md)
...
DDIM Inversion 是图像编辑的基础——先将真实图像反演到噪声空间，修改条件，再用 DDIM 采样回来，就能对真实图像进行编辑（详见 [图像编辑](../05-llm-era/04-image-editing.md)）。
...
> **下一篇**：[Score-based Models 详解](./03-score-based.md)
