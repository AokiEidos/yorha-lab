...
> ⚙️ 进阶 | 前置知识：[DDIM 详解](../02-models-zoo/02-ddim.md)，[CFG](../03-conditional-generation/03-cfg.md)，[采样算法](../01-fundamentals/04-sampling-algorithms.md)
...
> **下一篇**：[超分辨率与图像修复](./05-super-resolution.md) — Diffusion 如何在底层视觉任务中超越传统方法。
