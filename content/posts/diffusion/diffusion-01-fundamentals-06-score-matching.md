...
> ⚙️ 进阶 → 🔬 深入 | 前置知识：[反向过程与训练目标](./03-reverse-process.md)，基本微积分（梯度概念）
...
这个统一视角将在 [SDE/ODE 统一视角](./07-sde-ode.md) 中详细展开。
...
> **下一篇**：[SDE/ODE 统一视角](./07-sde-ode.md) — 用连续时间的随机/常微分方程统一 DDPM 和 Score-based 模型。
